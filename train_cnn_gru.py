...
parser = argparse.ArgumentParser(description='cnn_gru training')
...
class multi_gru(torch.nn.Module):
    def __init__(self):
        ...
        self.gru = nn.gru(2048, 512, batch_first=True, dropout=1)
    ...
    if multi_optim == 0:
        ...
        if optimizer_choice == 0:
            optimizer = optim.SGD([
                ...
                {'params': model.module.gru.parameters(), 'lr': learning_rate},
