...
def test_model(test_dataset, test_num_each):
    ...
    model = torch.load('lstm_epoch_25_length_10_opt_1_batch_400_train_9955_val_8448.pth')
    ...
    print(len(all_preds))
    with open('lstm_epoch_25_length_10_opt_1_batch_400_train_9955_val_8448_preds.pkl', 'wb') as f:
