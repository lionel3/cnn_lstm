...
parser = argparse.ArgumentParser(description='cnn_lstm_fc training')
...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    if multi_optim == 0:
        if optimizer_choice == 0:
            optimizer = optim.SGD([model.parameters(), kl_fc_p2t.parameters()], lr=learning_rate, momentum=momentum, dampening=dampening,
            ...
            optimizer = optim.Adam([model.parameters(), kl_fc_p2t.parameters()], lr=learning_rate)
    elif multi_optim == 1:
        if optimizer_choice == 0:
            optimizer = optim.SGD([
    ...
    np.save('kl_fc_p2t', kl_fc_p2t_np)
