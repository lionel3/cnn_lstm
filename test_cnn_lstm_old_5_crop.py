...
parser.add_argument('-a', '--average', default=False, type=bool, help='whether to use 5 crop, default False')
...
def test_model(test_dataset, test_num_each):
    ...
    # with open('cnn_lstm_epoch_25_length_10_opt_1_batch_400_train1_9993_train2_9971_val1_9692_val2_8647_preds_5_1.pkl', 'wb') as f:
    #     pickle.dump(all_preds_1, f)
    # with open('cnn_lstm_epoch_25_length_10_opt_1_batch_400_train1_9993_train2_9971_val1_9692_val2_8647_preds_5_2.pkl', 'wb') as f:
