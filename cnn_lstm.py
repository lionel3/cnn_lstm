...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    num_train_we_use = len(train_useful_start_idx) //(train_batch_size//sequence_length) * (train_batch_size//sequence_length)
    num_val_we_use = len(val_useful_start_idx) // (train_batch_size // sequence_length) * (train_batch_size // sequence_length)
    ...
    for epoch in range(epoches):
        ...
        print('epoch: {:4d} train completed in: {:.0f}m{:.0f}s accuracy {:.4f}'.format(epoch, train_elapsed_time // 60,
                                                                       train_elapsed_time % 60, train_accuracy))
